...
- 自动下载 google-bert/bert-base-chinese
...
# 全局离线检查（如果缓存存在，优先使用）
if os.path.exists("/root/.cache/huggingface/hub/models--google-bert--bert-base-chinese"):
    os.environ["HF_HUB_OFFLINE"] = "1"

# -------------------------- 配置参数 --------------------------
FILE_PATH = "./generate/backfill_cleaned.jsonl"
OUTPUT_FILE_PATH = "./generate/calculation_results_traditional_all.jsonl"
STATS_OUTPUT_PATH = "./generate/traditional_stats_all.json"
MAX_SAMPLES = 454  # 限制处理的样本数量，设为 None 则全部

# BERTScore 模型（短名，用于 bert_score 加载）
...
if __name__ == "__main__":
    ...
    # ==================== 新增：预下载通用 BERT 模型 ====================
    print("开始预下载通用 BERT 模型 (google-bert/bert-base-chinese)...")
    try:
